...
class cpt {
    ...
    */
	...
	/**
    * Delete all posts from this post type
    *
    */
	public function getAll(){
		$posts = get_posts( array( 'post_type' => $this->name, 'posts_per_page' => -1, 'orderby' => ID, 'order' => "ASC" ) );
    ...
    */
	public function deleteAll(){
		$posts = get_posts( array( 'post_type' => $this->name, 'posts_per_page' => -1 ) );
    ...
    */
	...
	function remove_cpt_slug( $post_link, $post, $leavename ) {
	    ...
	    if ( ! in_array( $post->post_type, array( $this->name ) ) || 'publish' != $post->post_status )
	        return $post_link;
	...
	function parse_request_tricksy( $query ) {
	    ...
	    if ( ! empty( $query->query['name'] ) )
	        $query->set( 'post_type', array( 'post', $this->name, 'page' ) );
	}
