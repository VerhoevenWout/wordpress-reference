		...
		<div class="row expanded results">
			<div class="fiches small-24 large-16 columns">
				...
				<div class="row expanded">
					...
					<fiche :key="index" v-for="(fiche, index) in fiches" v-on:mouseover="fichehover(fiche)" :fichedataprop="fiche" :translations='<?= jsonToProp($translations_json) ?>' :favarray="favarray" :ipaddressprop="ipaddress" :langprop="lang"></fiche>
